  ...
  <div class="addQuestion">
    ...
    <div class="addQuestion-bottom">
      <el-slider
        ...
        style="width:30%;"
      />
      <el-button type="primary" @click="centerDialogVisible = true" size="large">点击发布新问题!</el-button>
    </div>
    <el-dialog
...
onMounted(() => {
    ...
    setTimeout(() => {
      valueHtml.value = '<h1 style="text-align: center;">我是问题标题内容哦</h1><hr/><p>我是你要输入的问题哦!同时我也支持markdown语法哦!</p><p style="text-align: left;">开始发出问题吧!!!!!!</p>'
    }, 1500)
})
